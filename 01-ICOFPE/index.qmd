...
I'm not an agronomist or an economist, and I can barely keep houseplants alive, so you'll have to bear with me.
I'm using some example data and I've fit some very basic models that are probably not correct, but are useful for demonstrating how to use different types of charts. 
