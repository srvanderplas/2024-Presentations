...
+-------------+-------------------------------------------+--------------+
| democratic  | ![](bidirectional-gradient-redblue.png)   | republican   |
+-------------+-------------------------------------------+--------------+
...
-   These associations depend on culture -- ask around if you're unsure!
-   Avoid pink = female, blue = male

## Categorical Scales

-   **Working memory**: you can remember between 5 and 9 (7 plus or minus 2) things without writing them down

-   Avoid legends that have more than 7 categories

-   It can help to use color schemes that vary hue (color) and lightness: ![](paired-cat-color.png){.vcenter}
...
-   [from Data to Viz](https://www.data-to-viz.com/): https://www.data-to-viz.com/

    -   R, Python, D3.js, React code examples for each chart

    -   Useful for everyone for finding the right chart
...
| Program                                                                                                            | Resources                                                                                               |
+====================================================================================================================+=========================================================================================================+
| ![](https://www.r-project.org/logo/Rlogo.svg){width="60" height="50"}                                              | <https://r-graph-gallery.com/>                                                                          |
+--------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
| ![](https://s3.dualstack.us-east-2.amazonaws.com/pythondotorg-assets/media/files/python-logo-only.svg){width="41"} | <https://python-graph-gallery.com/>                                                                     |
+--------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
| ![](https://upload.wikimedia.org/wikipedia/commons/e/ea/SPSS_logo.svg){width="50"}                                 | Chart Builder                                                                                           |
|                                                                                                                    |                                                                                                         |
|                                                                                                                    | Graphs -\> Legacy Dialogs -\> ...                                                                       |
|                                                                                                                    |                                                                                                         |
|                                                                                                                    | [Documentation](https://www.ibm.com/docs/en/spss-statistics/30.0.0?topic=features-legacy-dialog-charts) |
+--------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
| ![](https://upload.wikimedia.org/wikipedia/commons/1/10/SAS_logo_horiz.svg){width="120" height="50"}               | Export data, import into R/Python                                                                       |
+--------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
| ![](excel.svg){width="161" height="50"}                                                                            | Export data, import into R/Python                                                                       |
+--------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
