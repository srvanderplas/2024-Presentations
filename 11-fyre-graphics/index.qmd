...
<!--   | Chart Builder  [Documentation](https://www.ibm.com/docs/en/spss-statistics/30.0.0?topic=features-legacy-dialog-charts) -->
<!--  | <https://www.mathworks.com/products/matlab/plot-gallery.html>  -->
<!--    | Export data, import into R/Python    -->
<!--   | Export data, import into R/Python -->
...
&nbsp; | Program                      | Resources/Strategy 
:-: | --- | ---------------------------------------
{{< iconify devicon:r >}} | R     | [https://r-graph-gallery.com](https://r-graph-gallery.com)
{{< iconify devicon:python >}} | Python  | [https://python-graph-gallery.com](https://python-graph-gallery.com)
...
{{< iconify devicon:matlab >}} | Matlab | [https://www.mathworks.com/products/matlab/plot-gallery.html](https://www.mathworks.com/products/matlab/plot-gallery.html)
